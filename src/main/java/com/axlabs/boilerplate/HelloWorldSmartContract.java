...
public class HelloWorldSmartContract {
    ...
    public static void request(String url, String filter, int gasForResponse) {
        new OracleContract().request(url, filter, "finish", null, gasForResponse);
    }

    public static void finish(String url, Object userData, int responseCode, ByteString response) {
