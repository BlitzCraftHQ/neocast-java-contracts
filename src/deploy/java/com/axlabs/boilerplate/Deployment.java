...
public class Deployment {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        CompilationUnit res = new Compiler().compile(NeocastContract.class.getCanonicalName());

        System.out.println(OWNER_ACCOUNT.getAddress());
        ...
        if (log.getExecutions().get(0).getState().equals(NeoVMStateType.FAULT)) {
            // Alice might not have any GAS. If you're running a neo express instance run
        ...
        // Calculate the contract hash from the deployment parameters and the deployer
        // account.
